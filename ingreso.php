...
<body>
    ...
    <div class="openproduct">
        <form method="POST" action="main/inbound.php">
            ...
            <div class="form-button">
                <button type="submit" class="inbound" style="float:right">Ingresar</button>
                <a name="" id="" class="return" href="inbound.php" role="button" style="float:left">Volver</a>
            </div>
        </form>
    </div>
    <?php
